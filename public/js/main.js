...
var App = new _vue2.default({
    ...
    methods: {
        getPhotos: function getPhotos() {
            return this.$http.get('/api/photos').then(function (response) {
        ...
        updateData: function updateData() {
            ...
            var data = this.getPhotos();
            this.$set('$loadingAsyncData', true);
            data.then(function (response) {
                for (var key in response) {
                    _this2.$set(key, response[key]);
                }
                _this2.$set('$loadingAsyncData', false);
                _this2.$emit('async-data');
            });
        },
        loadSalvattore: function loadSalvattore() {
            salvattore.recreateColumns(document.querySelector('#grid'));
            this.createTimeout();
        }
    },
    events: {
        'async-data': function asyncData() {
            var _this3 = this;

            this.$nextTick(function () {
                _this3.loadSalvattore();
            });
        }
    },
    data: {
...
},{"vue":4,"vue-async-data":2,"vue-resource":3}]},{},[5]);
